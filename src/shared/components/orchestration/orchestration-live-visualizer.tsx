...
const STAGE_NODE_GROUPS = {
  ...
  SELF_CRITIQUE: ["qa_review", "self_critique", "security_review"],
...
function buildStages(input: {
  ...
  return [
    ...
    {
      id: "contract",
      label: "Planner + Gate 1",
      subtitle: "Locked scope, bounded agent team, and approval boundary.",
    ...
    },
    {
      ...
      subtitle: "Only the specialists selected by the locked plan run.",
    ...
    },
    {
      ...
      subtitle: "QA, integration, and conditional security review.",
