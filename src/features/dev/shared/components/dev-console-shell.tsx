...
// Messages is deliberately absent. There was a developer-to-project-manager inbox here; it was a
// second place to raise the same things the issue board and work orders already carry, and being
// optional to read made it worse than not having one. Delivery talk belongs on the work it is about.
